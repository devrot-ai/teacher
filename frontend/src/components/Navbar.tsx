    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-orange-500 text-sm font-medium">
          ...
          <a className="hover:text-orange-600 flex items-center gap-2 transition-colors" href="/tools">
      ...
      <>
        ...
        >
          <nav className="flex flex-col gap-1">
            ...
            <a className="flex items-center gap-2.5 px-3 py-2 text-orange-500 text-sm font-medium rounded-lg hover:bg-orange-50 hover:text-orange-600 transition-all" href="/tools" onClick={closeMenu}>
